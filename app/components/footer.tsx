...
const Footer = () => {
    return (
        <footer className="bg-black text-white py-12">
            <div className="w-full md:w-[90%] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><a href="#" className="hover:text-red-500">Become a Sponsor</a></li>
