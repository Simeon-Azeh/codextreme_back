...
export default function EventDetails() {
    return (
        <>
            <div className="mt-16 flex gap-10 flex-row w-full justify-between">
                <div>
            ...
            <div className="flex flex-row justify-between gap-10 pt-20">
                <div>
                    <h2 className="text-9xl font-bold">200+</h2>
                    <p className="text-5xl">Target Attendance</p>
                </div>
                <div>
                    <h2 className="text-9xl font-bold text-[#e88080]">3 days</h2>
                    <p className="text-5xl">Intense learning and building.</p>
                </div>
            </div>
            <div className="py-20">
                <h2 className="text-9xl font-bold text-[#6f6f6f]">1 full day</h2>
                <p className="text-5xl">Career Fair with our sponsors.</p>
            </div>
        </>
    );
}